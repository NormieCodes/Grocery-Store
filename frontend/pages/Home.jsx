						...
						{allItems.length > 4 && (
							<div className="flex justify-center mt-8">
								<button 
									...
									className="bg-slate-800 hover:bg-slate-700 text-yellow-500 border border-yellow-500 px-8 py-2 rounded-full font-semibold transition duration-300 cursor-pointer">
